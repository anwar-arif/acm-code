...
bool a[35][35],visited[N];
int r,c,hole,match[N],val[35][35];
vector<int>g[N];
...
bool valid(int x,int y){
    if(x >= 1 and x <= r and y >= 1 and y <= c and !a[x][y])return true;
    return false;
}
