...
int main()
{
      ...
      //Write;
      #endif
      int cas = 0,v1,v2,d1,d2;
      while(sc4i(v1,d2,v2,d2)==4)
      {
          ...
          if(t != (int)T)
          {
              ...
              if(t1>=t2)
              {
                  pf("Case #1: You owe me a beer!\n",++cas);
                  pf("Avg. arrival time: %d/%d\n",p1,p2);
              }
              else{
                pf("Case #%d: No beer for the captain.\n",++cas);
                pf("Avg. arrival time: %d/%d\n",p1,p2);
              }
          }
          else
          {
              if(t1>=t2)
              {
                  pf("Case #%d: You owe me a beer!\n",++cas);
                  pf("Avg. arrival time: %d\n",t);
              }
              else
              {
                  pf("Case #%d: No beer for the captain.\n",++cas);
